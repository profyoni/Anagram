...
class TempTest {
    ...
    void canonicalForm() {
        String actual = Temp.canonicalForm("ASDFAGH");

        assertEquals("AADFGHS", actual);
    }
    @org.junit.jupiter.api.Test
    void FindAllAnagrams() {
        List<List<String>> actual = Temp.FindAllAnagrams(Arrays.asList(new String [] {"MAD", "BOB", "DAM"}));
    ...
    void FindAllAnagrams2() {
        List<List<String>> actual = Temp.FindAllAnagrams(Arrays.asList(new String [] {"MAD","BBoa",  "BOaB", "AMd"}));
